...
export const BikeFilterControls = ({
  filters,
  currentFilters,
  onFilterChange,
  onClearFilter,
}) => {
  const { make, category, fuelType, transmission, priceRange } = currentFilters;
  ...
  const filterSections = [
    ...
    },
    {
      id: "category",
      title: "Category",
      options: filters.categories.map((type) => ({ value: type, label: type })),
