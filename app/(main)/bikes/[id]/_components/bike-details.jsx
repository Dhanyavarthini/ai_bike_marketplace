...
export function BikeDetails({ bike, testDriveInfo }) {
  ...
  const handleSaveBike = async () => {
    ...
    if (savingBike) return;

    // Use the toggleSavedBikeFn from useFetch hook
    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this ${bike.year} ${bike.make} ${bike.model} on BikeBay!`,
  ...
  const handleBookTestDrive = () => {
    ...
    router.push(`/test-drive/${bike.id}`);
  };
      ...
      <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex gap-2 overflow-x-auto pb-2">
              {bike.images.map((image, index) => (
                ...
                >
                  <Image
                    src={image}
                    alt={`${bike.year} ${bike.make} ${bike.model} - view ${
                      index + 1
                    }`}
                    fill
                    className="object-cover"
        ...
        <div className="w-full lg:w-5/12">
          <div className="flex items-center justify-between">
            <Badge className="mb-2">{bike.category}</Badge>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 my-6">
            ...
            <div className="flex items-center gap-2">
              <Bike className="text-gray-500 h-5 w-5" />
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>BikeBay Bike Loan Calculator</DialogTitle>
          ...
          <Card className="my-6">
            <CardContent className="p-4">
              ...
              <a href="mailto:contact.bikebay@gmail.com">
          ...
          {(bike.status === "SOLD" || bike.status === "UNAVAILABLE") && (
            <Alert variant="destructive">
              <AlertTitle className="capitalize">
                This bike is {bike.status.toLowerCase()}
              </AlertTitle>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
            ...
            {bike.seats && (
              <div className="flex justify-between py-2 border-b">
                ...
                <span className="font-medium">{bike.seats}</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium">BikeBay</h4>
