...
export function TestDriveForm({ bike, testDriveInfo }) {
      ...
      <div className="md:col-span-1">
        <Card>
          <CardContent className="p-6">
            <h2 className="text-xl font-bold mb-4">Bike Details</h2>
          ...
          <CardContent className="p-6">
            ...
            <div className="text-sm">
              <p className="font-medium">
                {dealership?.name || "BikeBay Motors"}
              </p>
            ...
            <div className="py-4">
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{dealership?.name || "BikeBay Motors"}</span>
                </div>
              </div>
