...
import { bikeCategories, bikeMakes, faqItems } from "@/lib/data";
import { Bike, Calendar, ChevronRight, Shield } from "lucide-react";
...
import { BikeCard } from "@/components/bike-card";
import { getFeaturedBikes } from "@/actions/home";
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">
              BikeBay — Where AI meets the road.
            </h1>
            <p className="text-xl text-gray-500 mb-8 max-w-2xl mx-auto">
              Find the right bike faster with AI search, filters, and auto-listing tools.</p>
          </div>  
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  Thousands of vehicles from trusted dealerships and private sellers.
                  </p>
                </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {bikeCategories.map((type)=>{
              return <Link key={type.name}
            href={`/bikes?type=${type.name}`}
